...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyproject-api-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyproject-api-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pyproject-api
# for installing globally
pixi global install pyproject-api
```
...
It is possible to list all of the versions of `pyproject-api` available on your platform:
...
```
pixi search pyproject-api --channel conda-forge
```
